...
import com.homeaide.post.CommentsActivity;
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        firestore.collection("Posts/" + postId + "/Likes").document(currentUserId).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                 if (error == null){
                     if (value.exists()){
                         holder.likePic.setImageDrawable(context.getDrawable(R.drawable.like));
                     }else{
                         holder.likePic.setImageDrawable(context.getDrawable(R.drawable.likeme));
                     }
                 }
            }
        });
