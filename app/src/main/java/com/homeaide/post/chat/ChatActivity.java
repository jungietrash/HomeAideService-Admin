...
import com.homeaide.post.Adapter.ChatAdapter;
import com.homeaide.post.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        if (conversionId != null){
            ...
            conversion.put(Constants.KEY_RECEIVER_NAME, receiverUser.firstname);
    ...
    private void loadReceiverDetails(){
        ...
        binding.TextFirstName.setText(receiverUser.firstname);
        binding.TextLastName.setText(receiverUser.lastname);
