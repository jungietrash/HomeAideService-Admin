...
public class AddPostActivity extends AppCompatActivity {
    ...
    private ImageView mPostImage,backButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddPostActivity.this, RatingActivity.class);
                                        ...
                                        firestore.collection("Posts").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            ...
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                               if (task.isSuccessful()){
                                                   ...
                                                   startActivity(new Intent(AddPostActivity.this , RatingActivity.class));
                                                   finish();
                                               }else{
                                                   mProgressBar.setVisibility(View.INVISIBLE);
